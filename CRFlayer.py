...
class CRF(Layer):
    ...
    def __init__(self, units,
        ...
        self.kernel_regularizer = regularizers.get(kernel_regularizer) if kernel_regularizer!=None else None
        self.chain_regularizer = regularizers.get(chain_regularizer) if chain_regularizer!=None else None
        self.boundary_regularizer = regularizers.get(boundary_regularizer) if boundary_regularizer!=None else None
        self.bias_regularizer = regularizers.get(bias_regularizer) if bias_regularizer!=None else None

        self.kernel_constraint = constraints.get(kernel_constraint) if kernel_constraint!=None else None
        self.chain_constraint = constraints.get(chain_constraint) if chain_constraint!=None else None
        self.boundary_constraint = constraints.get(boundary_constraint) if boundary_constraint!=None else None
        self.bias_constraint = constraints.get(bias_constraint) if bias_constraint!=None else None
